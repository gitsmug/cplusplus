...
void HelloCanvas::render( wxPaintEvent& /* evt */)
{
	...
	mat4 rotationMatrix = glm::rotate(mat4(1.0f), glm::radians(54.0f), vec3(1.0f, 0.0f, 0.0f));
	mat4 projectionMatrix = glm::perspective(glm::radians(60.0f), aspectRatio, 0.1f, 10.0f);
