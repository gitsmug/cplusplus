...
ShapeData ShapeGenerator::MakePlaneVerts(uint dimensions_uint)
{
	int dimensions = dimensions_uint;
...
ShapeData ShapeGenerator::MakePlaneIndices(uint dimensions_uint)
{
	int dimensions = dimensions_uint;
...
ShapeData ShapeGenerator::makePlaneUnseamedIndices(uint tesselation_uint)
{
	int tesselation = tesselation_uint;
...
ShapeData ShapeGenerator::makeTorus(uint tesselation_uint)
{
	uint tesselation = tesselation_uint;
...
ShapeData ShapeGenerator::makeSphere(uint tesselation_uint)
{
	uint tesselation = tesselation_uint;
